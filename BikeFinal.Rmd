...
```{r corrplot, fig.width=6, fig.cap="Scatterplots and smoothed GAM fits of Bike Count vs. each covariate", dev = "CairoPDF"}
...
Figure 5 highlights a number of important relationships in the data.
...
Although in Figure 11 we can see both errors converge fairly fast, the proposed
...
The Loss vs Epoch curve is shown in Figure 12 in which the progress of mode
...
Table 3 and Figure 15 report the MAE and RMSE for each model. Perhaps
