...
based on the recommendation of @fpp3. Finally, as with the other time-series
methods, fasster uses Kalman filtering and smoothing to interpolate missing
values, which will result in biased parameter estimates, though the bias will
be less than that from a model fit by excluding the missing values.
