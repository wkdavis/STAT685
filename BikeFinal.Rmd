...
The hyperparameters of our model are evaluated using TSCV, yielding an optimal *mtry* value of 53. @probst suggests that such a high value usually indicates a high number of relevant predictors.
...
In this case, bike demand can be assumed to be a season with a daily (24 hours)
period.
