...
not need to be imputed. We will use
...
seasonality. @fasster's fasster methodology allows for the seasonal (and trend)
...
```{r fasster, fig.cap="ACF and PACF of the residuals from the fasster model."}
library(fasster)
